...
function Landing() {
  ...
  useEffect(() => {
    fetch('https://20.244.108.174/api/faqs/')
  ...
  return (
    <>
      ...
      <div className='banner-section container '>
        <div className='row d-flex align-items-center pd-56'>
          <div className='col-12 col-md-6 col-lg-6'>
            <div className='banner-content '>
              ...
              <div className=' button-ios py-5'>
                <button className='ios-btn col-lg-5 col-12 col-md-5 mb-3'><span><img src="apple.png"></img></span>Download for ios</button>
                <button className='ios-btn col-lg-5 col-12 col-md-5 android mb-3'><span><img src="apple-d.png"></img></span>Download for Android</button>
              
              </div>
            </div>
          </div>
          <div className='col-12 col-md-6 col-lg-6 d-flex justify-content-center align-items-center p-0'>
            <img src="/mobiles.png" className="img-fluid ms-sm-0 w-100" alt="Mobiles"></img>
          </div>
        </div>

        <div className='row pd-56'>
          <div className='col-12'>
            <img src="imgpsh_fullsize_anim (1).png" className="img-fluid w-100" alt=""></img>
          </div>
        </div>
          ...
          <div className='col-12 col-md-7 col-lg-6'>
            <div className='wrap-do' style={{ position: 'relative' }}>
              ...
              {isHovered1 && (
                ...
                >
                  <h5 className='max-hover ms-4 p-3 mb-4'>    Direct the game's score with a single touch using our scorer app. Accurately log goals,</h5>
   </div>
              )}
            </div>
          </div>
        ...
        <div className='row pd-56 d-flex align-items-center justify-content-center p-wrap'>
        <div className='col-12 col-md-7 col-lg-6'>
            ...
            >
              ...
              {isHovered2 && (
                ...
                >
                  <h5 className='max-hover-1 ms-4 p-3 mb-4'>Direct the game's score with a single touch using our scorer app. Accurately log goals, </h5>
   </div>
              )}
            </div>
          </div>
        ...
        <div className='col-12 col-md-7 col-lg-6'>
            <div className='wrap-do-1' style={{ position: 'relative' }}>
              ...
              >
                ...
                <h5 className='more-text-1'>
                Embrace the excitement of sports in your language with our app. Enjoy live commentary, real-time updates, and all the highlights in your preferred language.  language barriers and<br></br> connect with the game like never before.
                </h5>
              </div>
              {isHovered4 && (
                <div
                  className="most-wide-1"
                  style={{
                    top: document.querySelector('.do-first').offsetHeight + 10, 
                    right: 0, 
                    width: '100%', 
