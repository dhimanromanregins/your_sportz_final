...
function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://20.244.108.174/api/register/', {
        method: 'POST',
        headers: {
              ...
              <form className='login-content' onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                  <label htmlFor="terms" className="checkbox-label my-5">
                    ...
                    <span>
      I agree to the <span className="terms-span"onClick={handleTermsClick}>Terms of Service</span> and{' '}
      <span className="terms-span"onClick={handlePrivacyClick}>Privacy Policy</span>
    </span>
                  </label>
