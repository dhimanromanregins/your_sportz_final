              ...
              <form className='login-content' onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                  <label htmlFor="terms" className="checkbox-label my-5">
                    ...
                    <span>I agree to the <a className="terms-span" onClick={handleTermsClick} target="_blank">Terms of Service</a> and <a className="terms-span" onClick={handlePrivacyClick} target="_blank">Privacy Policy</a></span>
